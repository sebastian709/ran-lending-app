            ...
            <div class="container mx-auto px-4 py-3">
                <div class="flex justify-between items-center">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <button onclick="window.location.href='login.html'" class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap">Login</button>
                    </div>
                ...
                <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4">
                    <div class="flex flex-col space-y-4">
                        ...
                        <button class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap w-full">Login</button>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div class="text-white">
                        <h1 class="text-4xl md:text-5xl font-bold mb-6">Experience a Smoother Way to Borrow — With Confidence</h1>
                        <p class="text-xl mb-8">Experience hassle-free loans with peace of mind.</p>
                        <div class="flex flex-wrap gap-4">
                            <button class="bg-white text-primary px-8 py-3 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap">Apply Now</button>
                            <button class="bg-transparent border-2 border-white text-white px-8 py-3 rounded-button font-medium hover:bg-white/10 transition-all whitespace-nowrap">Get Started</button>
                        </div>
                    </div>
                    <div class="relative">
                        <div
        ...
        <section class="py-20 bg-white" id="about">
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-600 max-w-3xl mx-auto">Get started with our straightforward application process and receive a decision quickly.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Complete our simple online application form with your basic information.</p>
                    </div>
                    <div class="text-center">
                        <div class="w-16 h-16 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6 mx-auto">
                ...
                <div class="text-center mt-12">
                    <button class="bg-primary text-white px-8 py-3 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap">Start Application</button>
                </div>
            </div>
        </section>
        <!-- Why Choose Us -->
        <section class="py-20 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-600 max-w-3xl mx-auto">Experience the difference of working with a lender who puts your needs first.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white p-8 rounded-lg shadow-md">
                        ...
                        <p class="text-gray-600">Get a decision on your loan application within 24-48 hours with our streamlined process.</p>
                    </div>
                    <div class="bg-white p-8 rounded-lg shadow-md">
                        <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                        ...
                        <p class="text-gray-600">Access some of the most competitive interest rates in the market, helping you save money.</p>
                    </div>
                    <div class="bg-white p-8 rounded-lg shadow-md">
                        <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                        ...
                        <p class="text-gray-600">Our experienced lending specialists are here to guide you through every step of the process.</p>
                    </div>
                </div>
            </div>
        </section>
