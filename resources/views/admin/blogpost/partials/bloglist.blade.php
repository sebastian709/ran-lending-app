    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="card blog-card border-0 shadow-sm overflow-hidden h-100 rounded position-relative">
            ...
            <div class="position-relative">
                ...
                <span class="badge bg-white text-dark position-absolute top-0 start-0 m-2 d-flex align-items-center px-2 py-1 gap-1 shadow-sm"
            ...
            <div class="p-3 bg-white d-flex flex-column justify-content-between h-100">
                ...
                <div class="pt-2 border-top d-flex justify-content-between align-items-center">
                    <div class="d-flex gap-3">
                        <a href="#" class="text-primary action-icon" title="View"><i class="bi bi-eye fs-5"></i></a>
                        <a href="#" class="text-secondary action-icon" title="Edit"><i class="bi bi-pencil-square fs-5"></i></a>
                        @if ($post->status === 'draft')
                            <a href="#" class="text-success action-icon" title="Publish"><i class="bi bi-upload fs-5"></i></a>
                        @endif
                    </div>
                    <a href="#" class="text-danger action-icon" title="Delete"><i class="bi bi-trash fs-5"></i></a>
                </div>
            </div>
        </div>
    </div>
