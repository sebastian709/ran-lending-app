        ...
        <div class="container mx-auto px-4 py-3">
            ...
            <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4">
                <div class="flex flex-col space-y-4">
                    <a href="/jewelry#" class="text-white hover:text-white/80 font-medium">Home</a>
                    <a href="/jewelry#about" class="text-white hover:text-white/80 font-medium">About</a>
                    <a href="/jewelry#Blog" class="text-white hover:text-white/80 font-medium">Blog</a>
                    <button type="button" data-url="/login"
