        ...
        <div class="container mx-auto px-4 py-3">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <button onclick="document.getElementById('donate-modal').classList.remove('hidden')" class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap">Donate</button>
                </div>
            ...
            <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4">
                <div class="flex flex-col space-y-4">
                    ...
                    <button onclick="document.getElementById('donate-modal').classList.remove('hidden')" class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap w-full">Donate</button>
                </div>
            </div>
        </div>
    </nav>
...
<section class="relative h-[80vh] flex items-center justify-center text-white overflow-hidden bg-cover bg-center-center" style="background-image: url('{{ asset('images/ran_serenity_hub_cover.png') }}');">
  ...
  <section class="py-20 bg-[#f5efef] text-center px-4">
      <div class="max-w-2xl mx-auto">
          ...
          <button onclick="document.getElementById('donate-modal').classList.remove('hidden')" class="bg-primary text-white px-6 py-3 rounded-button font-semibold hover:bg-primary/90 transition-all">
              Donate Now
          </button>
      </div>
  </section>
  ...
  <div id="donate-modal" class="fixed inset-0 bg-black/60 z-50 flex items-center justify-center hidden">
      <div class="bg-white max-w-lg w-full mx-4 rounded-lg shadow-lg p-8 relative">
          <!-- Close Button -->
          <button onclick="document.getElementById('donate-modal').classList.add('hidden')" class="absolute top-3 right-3 text-gray-400 hover:text-gray-600 text-2xl">
              &times;
          </button>
          ...
          <div class="flex justify-center mb-6">
              <img src="{{ asset('images/donation_qr.png') }}" alt="Donation QR Code" class="w-48 h-48 object-contain" />
          </div>
