            ...
            <div class="container mx-auto px-4 py-3">
                <div class="flex justify-between items-center">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <button class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap">Shop Now</button>
                    </div>
                ...
                <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4">
                    <div class="flex flex-col space-y-4">
                        ...
                        <button class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap w-full">Shop Now</button>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">
                    Explore our carefully curated collections featuring the finest materials and exceptional craftsmanship.
                </p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="jewelry-card bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">
                            Handcrafted gold rings with exquisite detailing — ideal for engagements, weddings, or personal indulgence.
                        </p>
                        <button class="bg-primary text-white px-6 py-2 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap w-full">
                            More Details
                        </button>
                    </div>
                </div>
                ...
                <div class="jewelry-card bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">
                            Radiant gold necklaces that blend timeless charm with contemporary sophistication — perfect for any occasion.
                        </p>
                        <button class="bg-primary text-white px-6 py-2 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap w-full">
                            More Details
                        </button>
                ...
                <div class="jewelry-card bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">
                            Stylish gold bracelets designed for elegance and everyday wear — a perfect blend of beauty and craftsmanship.
                        </p>
                        <button class="bg-primary text-white px-6 py-2 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap w-full">
                            More Details
                        </button>
    ...
    <section class="py-20 bg-[#f5efef]" id="about">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">Experience the difference of working with master jewelers who are passionate about creating exceptional pieces.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">
                        We offer a carefully selected range of high-quality pieces, chosen for their elegance, authenticity, and timeless appeal.
                    </p>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                    ...
                    <p class="text-gray-600">All our diamonds and precious stones are certified, ensuring authenticity and the highest quality standards.</p>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                    ...
                    <p class="text-gray-600">
                        We’re here to assist you with product inquiries, order support, and guidance to help you find the perfect piece.
                    </p>
                </div>
