            ...
            <div class="container mx-auto px-4 py-3">
                <div class="flex justify-between items-center">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <button class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap">Book Now</button>
                    </div>
                ...
                <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4">
                    <div class="flex flex-col space-y-4">
                        ...
                        <button class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap w-full">Book Now</button>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="text-white">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <button class="bg-transparent border-2 border-white text-white px-8 py-3 rounded-button font-medium hover:bg-white/10 transition-all whitespace-nowrap">Plan Your Trip</button>
                    </div>
                </div>
                <div class="relative">
    ...
    <section class="py-20 bg-white" id="about">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">Book your dream vacation in just a few easy steps and start your adventure with confidence.</p>
            </div>
            ...
            <div class="text-center mt-12">
                <button class="bg-primary text-white px-8 py-3 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap">Start Booking</button>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">Experience the difference of traveling with a company that puts your adventure and satisfaction first.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">Our experienced travel specialists craft personalized itineraries tailored to your interests and budget.</p>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                    ...
                    <p class="text-gray-600">Travel with confidence knowing we prioritize your safety with trusted partners and comprehensive insurance.</p>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                    ...
                    <p class="text-gray-600">Our dedicated support team is available around the clock to assist you throughout your journey.</p>
                </div>
            </div>
        </div>
    </section>
