            ...
            <div class="hidden md:grid md:grid-cols-5 h-[calc(100vh)]" id="heroGrid">
                ...
                <div data-url="/jewelry" class="group relative overflow-hidden cursor-pointer transition-all duration-500" id="jewelryHero">
                    ...
                    <div class="relative h-full flex flex-col justify-end p-8 text-white">
                        ...
                        <p class="text-sm mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">Adorn yourself with treasures that last a lifetime.</p>
                ...
                <div class="group relative overflow-hidden cursor-pointer transition-all duration-500" id="charityHero">
                    ...
                    <div class="relative h-full flex flex-col justify-end p-8 text-white">
                        ...
                        <p class="text-sm mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">Connecting Merchants. Uplifting Communities</p>
                        <button onclick="window.location.href='charity.html'" class="bg-white text-primary px-6 py-3 rounded-button font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-500 whitespace-nowrap">Learn More</button>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden card-hover">
                        <div class="p-8">
                            ...
                            <div class="flex items-center">
                                <button class="bg-primary text-white px-5 py-2 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap">Learn More</button>
                                <span class="ml-4 text-primary font-medium cursor-pointer flex items-center"> Shop Now <i class="ri-arrow-right-line ml-1"></i> </span>
                            </div>
                        </div>
                    </div>
                    <!-- Quote -->
