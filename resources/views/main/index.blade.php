    ...
    <body class="bg-gray-50">
            ...
            <div class="container mx-auto px-4 py-3">
                <div class="flex justify-between items-center">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#business" class="text-white hover:text-white/80 font-medium relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-white after:transition-all">Business</a>
                        ...
                        <button class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap">Get Started</button>
                    </div>
                ...
                <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4">
                    <div class="flex flex-col space-y-4">
                        ...
                        <button class="bg-white text-primary px-5 py-2 rounded-button font-medium hover:bg-white/90 transition-all whitespace-nowrap w-full">Get Started</button>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <section class="relative min-h-screen">
            <div class="hidden md:grid md:grid-cols-4 h-[calc(100vh)]" id="heroGrid">
                <!-- Lending -->
                <div data-url="/" class="group relative overflow-hidden cursor-pointer transition-all duration-500" id="lendingHero">
                    <div
                    ...
                    <div class="relative h-full flex flex-col justify-end p-8 text-white">
                        ...
                        <p class="text-sm mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">Flexible financial solutions tailored to your needs</p>
                        <button data-url="/" class="bg-white text-primary px-6 py-3 rounded-button font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-500 whitespace-nowrap">Learn More</button>
                    </div>
                </div>
                <!-- Jewelry -->
                <div data-url="/jewelry" class="group relative overflow-hidden cursor-pointer transition-all duration-500" id="jewelryHero">
                    <div
                    ...
                    <div class="relative h-full flex flex-col justify-end p-8 text-white">
                        ...
                        <p class="text-sm mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">Exquisite pieces for life's special moments</p>
                        <button data-url="/jewelry" class="bg-white text-primary px-6 py-3 rounded-button font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-500 whitespace-nowrap">Learn More</button>
                    </div>
                </div>
                <!-- Travel -->
                <div data-url="/travel-and-tours" class="group relative overflow-hidden cursor-pointer transition-all duration-500" id="travelHero">
                    <div
                    ...
                    <div class="relative h-full flex flex-col justify-end p-8 text-white">
                        ...
                        <p class="text-sm mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">Unforgettable journeys to dream destinations</p>
        ...
        <section class="py-20 bg-white" id="business">
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-600 max-w-3xl mx-auto">Explore our diverse range of businesses designed to meet your various needs from financial services to travel experiences.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden card-hover">
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 mb-6">Access flexible lending solutions tailored to your financial needs. Our competitive rates and personalized service make borrowing simple and accessible.</p>
                            <div class="flex items-center">
                                ...
                                <span class="ml-4 text-primary font-medium cursor-pointer flex items-center"> Visit Page <i class="ri-arrow-right-line ml-1"></i> </span>
                            </div>
                        </div>
                    </div>
                    <!-- Jewelry Business -->
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden card-hover">
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 mb-6">Discover our exquisite collection of handcrafted jewelry pieces. From timeless classics to contemporary designs, find the perfect expression of your style.</p>
                            <div class="flex items-center">
                                <button class="bg-primary text-white px-5 py-2 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap">Browse Collection</button>
                                <span class="ml-4 text-primary font-medium cursor-pointer flex items-center"> Visit Page <i class="ri-arrow-right-line ml-1"></i> </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden card-hover">
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 mb-6">Embark on unforgettable journeys with our curated travel experiences. From exotic destinations to cultural adventures, we create memories that last a lifetime.</p>
                            <div class="flex items-center">
                                <button class="bg-primary text-white px-5 py-2 rounded-button font-medium hover:bg-primary/90 transition-all whitespace-nowrap">Explore Packages</button>
                                <span class="ml-4 text-primary font-medium cursor-pointer flex items-center"> Visit Page <i class="ri-arrow-right-line ml-1"></i> </span>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-20 bg-gray-50" id="About">
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-600 max-w-3xl mx-auto">Our integrated approach to business allows us to provide comprehensive solutions that enhance your lifestyle and financial well-being.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white p-8 rounded-lg shadow-md">
                        <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                            <i class="ri-shield-check-line ri-2x"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-800 mb-3">Trusted Experience</h3>
                        <p class="text-gray-600">Our experience has earned the trust of clients across industries—delivering solutions that drive success.</p>
                    </div>
                    <div class="bg-white p-8 rounded-lg shadow-md">
                        <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                        ...
                        <p class="text-gray-600">Our customer-first approach means you'll always receive personalized attention and support tailored to your specific needs.</p>
                    </div>
                    <div class="bg-white p-8 rounded-lg shadow-md">
                        <div class="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary rounded-full mb-6">
                        ...
                        <p class="text-gray-600">We believe in giving back to the communities we serve, with a portion of all profits directed toward meaningful charitable initiatives.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-gradient-to-r from-primary to-secondary text-white" id="Social">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <p class="text-lg mb-8">Stay connected and updated with our latest news, offerings, and community stories from across our brands.</p>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
                        <a href="https://www.facebook.com/RANLending" target="_blank" class="bg-white text-primary px-6 py-4 rounded-button font-medium hover:bg-white/90 transition-all block text-center">
                            RAN Lending
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=61555856647935" target="_blank" class="bg-white text-primary px-6 py-4 rounded-button font-medium hover:bg-white/90 transition-all block text-center">
                            RAN Jewelry
                        </a>
                        <a href="https://www.facebook.com/nclicious" target="_blank" class="bg-white text-primary px-6 py-4 rounded-button font-medium hover:bg-white/90 transition-all block text-center">
                            RAN Travel & Tours
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=61567345372877" target="_blank" class="bg-white text-primary px-6 py-4 rounded-button font-medium hover:bg-white/90 transition-all block text-center">
                            RAN Serenity HUB
                        </a>
                    </div>
                </div>
